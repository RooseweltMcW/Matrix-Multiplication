...
int test_count=1;
int main(){
    const char *report_file = "report.csv";
    
    // Write headers once at the start of the program
    write_headers(report_file);
    ...
    while(1){
        ...
        if(A_col != B_row){
            ...
            // return 1;
        }else if(A_col <0 || A_row<0 || B_col<0 || B_row<0){
            printf("Negative number entered! input the correct values");
            return 1;
        }
